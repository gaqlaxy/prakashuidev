                        ...
                        <div className="flex flex-wrap gap-4 mb-2">
                            {categories.map((cat) => (
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-full border text-[10px] uppercase font-mono tracking-widest transition-all ${filter === cat ? 'bg-accent border-accent text-white' : 'border-white/10 text-secondary hover:border-white/30'
                                        }`}
                                >
                                    {cat}
                                </button>
