          ...
          <div className="lg:w-1/2">
            ...
            >
              <h1 className="text-6xl md:text-[8vw] font-medium tracking-tighter leading-none mb-12">
                To the new <br /> beginnings.
              </h1>

              <div className="space-y-8">
                <div>
                  <h3 className="text-[10px] uppercase tracking-[0.4em] text-accent mb-4 font-mono">
                    Mail Protocol
                  </h3>
                  <a
                    href="mailto:contactfeprakash@gmail.com"
                    className="text-2xl md:text-3xl font-light hover:text-accent transition-colors underline underline-offset-8 decoration-white/10"
                  >
              ...
              <div className="pt-12 border-t border-white/5">
                <h3 className="text-[10px] uppercase tracking-[0.4em] text-accent mb-8 font-mono">
                  Social Systems
                </h3>
              ...
              <form className="relative z-10 space-y-12">
                ...
                <div className="pt-8">
                  <MagneticButton>
                    <button
                      type="button"
                      className="w-24 h-24 md:w-32 md:h-32 rounded-full bg-accent text-white flex items-center justify-center text-sm font-bold uppercase tracking-widest hover:scale-105 transition-all"
                    >
                      Send
                    </button>
                  </MagneticButton>
